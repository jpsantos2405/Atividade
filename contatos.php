...
<html lang="pt-BR">
    ...
    <form> 
        ...
        <div>
        <br>
        <label for="campo_nome">Digite o tema do assunto:</label>
        <input id="campo_nome" type="text" placeholder="Digite o tema do assunto!">
        </div>
        
        <div>
        <br>
        <label for="campo_nome">Digite a mensagem:</label>
        <input id="campo_nome" type="text" placeholder="Digite a mensagem!">
        </div>
...
<script src="https://kit.fontawesome.com/71b2d8f455.js" crossorigin="anonymous"></script>
    </body>
