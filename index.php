...
<body>
    ...
    <header>
        ...
        <div class="empresa">
            <h1>Mazutti Automovéis</h1>
            <p>As melhores motos e carros da região Norte!</p>
    </header>
    <!-- menu de navegação -->
    <main>
        <div class="dest">
        ...
        <section id="Moto Naked">
            <h2>Moto Naked</h2>
            <div class="msn">
                <img src="images/Moto.jpg" width = "600">
                <p>A Moto Naked é perfeita para quem busca liberdade sobre duas rodas, 
        ...
        <h2>Carro Roadster</h2>
            <div class="msn">
                <img src="images/Tesla.jpg" width = "600">
                <p>O Carro Roadster é sinônimo de sofisticação, 
       ...
       <h2>Carro Crossover</h2>
            <div class="msn">
                <img src="images/Chevrolet.jpg"  width = "600">
                <p>O Carro Crossover é a escolha ideal para quem busca um veículo que 
        ...
        <h2>Moto Sports</h2>
            <div class="msn">
                <img src="images/MotoSports.jpg" width = "600">
                <p>A Moto Sports é feita para quem vive a paixão pela velocidade e 
